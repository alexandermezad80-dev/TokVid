...
-- The migration that originally defined this function was already recorded as applied;
-- this forward-only migration repairs the deployed definition without editing history.
